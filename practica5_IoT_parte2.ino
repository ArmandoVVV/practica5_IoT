...
WiFiClient  client;
// OpenWeather
String apiTemperature = "297aea0808e4f6c1f8f9ee5d01fadfb9";
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.601823&lon=-103.415793&appid=297aea0808e4f6c1f8f9ee5d01fadfb9&units=metric";
// ThingSpeak
uint32_t channelNumber = 2056575;
const char *writeAPIKey = "80NA5KCUOP8GY5GU";
void setup()
{
    Serial.begin(9600);
    dht.begin();
